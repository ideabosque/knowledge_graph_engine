...
def test_document_list_filter_builds_status_condition(mock_info):
    ...
    from knowledge_graph_engine.models.dynamodb.document import DocumentModel
...
def test_get_active_graph_schema_chooses_most_recent():
    from knowledge_graph_engine.models.dynamodb.graph_schema import get_active_graph_schema
    ...
    with patch("knowledge_graph_engine.models.dynamodb.graph_schema.GraphSchemaModel.query", return_value=[older, newer]):
        with patch("knowledge_graph_engine.models.dynamodb.graph_schema.Config.get_logger", return_value=logging.getLogger("test")):
...
def test_get_active_neo4j_instance_chooses_most_recent():
    from knowledge_graph_engine.models.dynamodb.neo4j_instance import get_active_neo4j_instance
    ...
    with patch("knowledge_graph_engine.models.dynamodb.neo4j_instance.Neo4jInstanceModel.query", return_value=[older, newer]):
        with patch("knowledge_graph_engine.models.dynamodb.neo4j_instance.Config.get_logger", return_value=logging.getLogger("test")):
...
def test_list_resolvers_raise_when_partition_key_missing():
    ...
    """
    from knowledge_graph_engine.models.dynamodb.document import resolve_document_list as doc_list
    from knowledge_graph_engine.models.dynamodb.graph_schema import resolve_graph_schema_list as gs_list
    from knowledge_graph_engine.models.dynamodb.neo4j_instance import resolve_neo4j_instance_list as ni_list
    from knowledge_graph_engine.models.dynamodb.request import resolve_request_list as req_list
